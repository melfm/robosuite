...
class Reach(SingleArmEnv):
    ...
    Args:
        ...
        camera_segmentations (None or str or list of str or list of list of str): Camera
         ...
         max_object_distance: max distance in meters to randomize object from end effector
    Raises:
    ...
    def __init__(
        ...
        max_object_distance=0.2,
    ):
        self.max_object_distance = np.abs(max_object_distance)
...
class ReachEasy(Reach):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(max_object_distance=0.1, **kwargs)
...
class ReachMedium(Reach):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(max_object_distance=0.2, **kwargs)
...
class ReachHard(Reach):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(max_object_distance=0.5, **kwargs)